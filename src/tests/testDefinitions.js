export const testDefinitions = [
  ...
  },
  {
    ...
    agentPrompt: `Hi Mero, please schedule a 30-minute wellness exam for Sammy (DOMESTIC SH, feline) with Dr. Smith next Tuesday at 10 AM. Confirm the appointment via SMS to owner Alex Morgan and email a reminder 24 hours before. Let me know when it's booked.`
  },
  {
    id: 'workflow-3',
    ...
    agentPrompt: `Hi Mero, Wilson has just arrived for his appointment. Please begin the check-in process: confirm his client information, capture his weight, complete triage notes and assign him to an exam room. Let me know when he is ready for the doctor.`
  },
  {
    id: 'workflow-4',
    ...
    agentPrompt: `Mero, open Wilson's medical record and create a new SOAP note for today's wellness visit. Use the canine wellness template, document normal findings, prescribe monthly heart-worm prevention, and finalize the note.`
  },
  {
    id: 'workflow-5',
    ...
    agentPrompt: `Mero, for Wilson please order a CBC/chemistry panel and thoracic radiographs. Generate the lab requisition and attach the orders to his record.`
  },
  {
    id: 'workflow-6',
    ...
    agentPrompt: `Mero, build a treatment plan for Bella's hip dysplasia: include hip radiographs, joint supplements, and a 6-session laser therapy package. Generate an estimate and present it for owner approval.`
  },
  {
    id: 'workflow-7',
    ...
    agentPrompt: `Mero, dispense Apoquel 5.4 mg tablets for Sammy: 1 tablet twice daily for 14 days with 2 refills. Deduct inventory, print the prescription label and record lot & expiry.`
  },
  {
    id: 'workflow-8',
    ...
    agentPrompt: `Mero, finalize today's charges for Max, apply his 10 % senior discount, collect $150 by credit card and place the remaining $50 on account. Email the paid receipt to owner Michael Chen.`
  },
  {
    id: 'workflow-9',
    ...
    agentPrompt: `Mero, generate vaccine reminders for all patients due next month, batch send the email reminders, and show me the send-status report.`
  },
  {
    id: 'workflow-10',
    ...
    agentPrompt: `Mero, run end-of-day: close all open invoices, count the cash drawer (expected $520), adjust inventory for dispensed items, and email the daily financial & productivity reports to management.`
  },
];
